...
# For the first clean baseline, keep the head linear.
HEAD_NUM_LAYERS=1
HEAD_HIDDEN_SIZE=-1
...
echo
echo "========================================"
echo "Step 1: Building hap_pair AS classification dataset"
echo "========================================"
...
echo
echo "========================================"
echo "Step 3: Training entexBERT-2 hap_pair AS classification model"
echo "========================================"
