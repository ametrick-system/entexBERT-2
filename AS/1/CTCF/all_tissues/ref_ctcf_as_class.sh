...
# Start with one reference sequence only, not hap1/hap2 pair
...
RUN_NAME="${INPUT_MODE}_${TARGET_NAME}_${DONOR}_${TISSUE_LABEL}_AS_classification"
...
EXPERIMENT_DIR="$PROJECT_DIR/AS/${DONOR_NUMBER}/${ASSAY_NICKNAME}/${TISSUE_LABEL}/${INPUT_MODE}_classification"
...
# For the first normal baseline, keep the head simple.
HEAD_NUM_LAYERS=1
HEAD_HIDDEN_SIZE=-1
...
echo
echo "========================================"
echo "Step 1: Building AS classification dataset"
echo "========================================"
...
########################################
# Step 1.5: Check for duplicate-sequence leakage
########################################

echo
echo "========================================"
echo "Step 1.5: Checking duplicate sequence leakage across splits"
echo "========================================"
...
echo
echo "========================================"
echo "Step 3: Training entexBERT-2 AS classification model"
echo "========================================"
