...
# The dataset step is now config-driven. We generate the config from the variables
# above (single source of truth) and hand it to run_experiment. "ALL" tissue is
# treated as pool-all-tissues; splitting is leakage-safe by locus (group: locus).
